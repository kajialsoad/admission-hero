                      ...
                      Expanded(
                          child: Column(
                            ...
                            if (questions.isNotEmpty)
                              Text(
                                  'Unit ${questions.first.unit ?? ''} • Session ${questions.first.session ?? ''}',
                    ...
                    Container(
                      ...
                      child: Row(
                          ...
                          children: [
                            ...
                            Container(
                                width: 1, height: 24, color: Colors.white30),
                            _headerStat('Remaining',
                                '${questions.length - _selectedAnswers.length}'),
                          ]),
                    ),
                  ]),
                ),
                    ...
                    child: _showAnswers
                        ...
                        : Column(mainAxisSize: MainAxisSize.min, children: [
                            Row(
                                ...
                                children: [
                                  Text(
                                      'Progress: ${_selectedAnswers.length}/${questions.length}',
                                      style: const TextStyle(
                                          fontSize: 12,
                                          fontWeight: FontWeight.w600,
                                          color: AppColors.textSecondary)),
                                  Text(
                                      '${((_selectedAnswers.length / questions.length) * 100).toStringAsFixed(0)}%',
                                      style: const TextStyle(
                                          fontSize: 12,
                                          fontWeight: FontWeight.w700,
                                          color: AppColors.primary)),
                      ...
                      children: [
                        ...
                        Text('$score/${questions.length}',
                            style: const TextStyle(
                                ...
                                fontWeight: FontWeight.w700)),
                        Text(
                            '${((score / questions.length) * 100).toStringAsFixed(1)}% Correct',
                            style: const TextStyle(
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              if (_showAnswers)
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _selectedAnswers[q.id] == q.correctAnswer
                        ? AppColors.successLight
                        : AppColors.errorLight,
                    borderRadius: BorderRadius.circular(20),
                  ),
                  child: Text(
                    _selectedAnswers[q.id] == q.correctAnswer
                        ? '✓ Correct'
                        : '✗ Wrong',
                    style: TextStyle(
                        fontSize: 11,
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    Container(
                      ...
                      height: 24,
                      decoration: BoxDecoration(
                        color: _showAnswers && isCorrect || isSelected
                    ...
                    children: [
                      ...
                      Expanded(
                          child: Column(
                            ...
                            MathText(q.explanations!.first['content'] ?? '',
                                textStyle: const TextStyle(
                                    fontSize: 12,
                                    color: AppColors.textPrimary,
                                    height: 1.4)),
            ...
            if (_showAnswers) ...[
              ...
              Container(
                ...
                child: Row(children: [
                  ...
                  const SizedBox(width: 8),
                  Text('Correct Answer: Option ${q.correctAnswer}',
                      style: const TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.w700,

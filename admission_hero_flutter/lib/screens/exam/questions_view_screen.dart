              ...
              child: Row(children: [
                ...
                Expanded(
                    child: Column(
                      ...
                      Text(
                          '${widget.questionSet.universityName} • Unit ${widget.questionSet.unit} • ${widget.questionSet.session}',
                          style: const TextStyle(
                  ...
                  if (exam.error != null) {
                    return Center(
                      ...
                      ElevatedButton.icon(
                        onPressed: () => context
                            .read<ExamProvider>()
                            .loadExam(widget.questionSet.id),
